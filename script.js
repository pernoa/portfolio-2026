...
techtaka: {
  ...
  holiday: {
    ...
    whyCards: [
      {
        ...
        desc: '올거나이즈에서 엔터프라이즈 AI 필드리포트 한글 4편(타임아웃·PII 마스킹·GPU 경합·RAG 사일런트 장애)과 영문 2편(EP.01/02), 에이전틱 AI 가이드 시리즈 10편을 기획·초안·발행까지 주도했습니다. 기술 리더십 검수와 AI 도구 보조를 결합해 완성하는 루틴이며, 상위 5개 콘텐츠 기준 문의 전환율 9.5~14.3% (2025 하반기~2026 1분기). 올거나이즈 신규 홈페이지 개편도 주도하고 있습니다 (프로토타입 allganize-home-v4.surge.sh). LLM·RAG·MCP·온프레미스·보안 같은 개념을 엔터프라이즈 IT·AI 리더와 개발자 독자층으로 번역한 실무이며, VLS·로봇 제어 콘텐츠에도 같은 프로세스를 출발점으로 삼을 수 있습니다.'
      },
      {
        num: '02',
    ...
    jdRows: [
      ...
      { req: '엔지니어 대상 기술 글쓰기',                      project: '올거나이즈',                  result: '엔터프라이즈 AI 필드리포트 한글 4편(EP.01~04) + 영문 2편 + 에이전틱 AI 가이드 10편. 전환율 9.5~14.3%' },
