...
const COMPANIES = {
  ...
  holiday: {
    ...
    whyCards: [
      {
        num: '01',
        title: '엔지니어가 읽을 수 있는 장문 기술 콘텐츠를 이미 만들어왔습니다',
        desc: '올거나이즈에서 온프레미스 AI 필드 리포트 2편(한·영), 에이전틱 AI 가이드 시리즈 10편을 기획·초안·발행까지 직접 주도했고, 기술 리더십 검수와 AI 도구 보조를 결합해 완성했습니다. 상위 5개 콘텐츠 기준 문의 전환율 9.5~14.3% (2025 하반기~2026 1분기). LLM·RAG·MCP·온프레미스·보안 같은 복잡한 기술 개념을 엔터프라이즈 IT·AI 리더 대상으로 번역해 온 실무입니다. VLS·로봇 제어 콘텐츠에도 같은 프로세스 — 엔지니어 인터뷰 → 현장 정리 → 독자 세분화 → 시리즈 설계 — 를 출발점으로 삼을 수 있습니다.'
      },
      {
        num: '02',
        title: '다섯 도메인을 거치며 매번 새 분야의 언어를 빠르게 익혔습니다',
        desc: '순수 B2B 실무는 약 3년 6개월(마롱 2년 6개월 + 올거나이즈 약 1년), 디지털 대행사에서 수행한 B2B/B2G 캠페인은 2년 9개월, 나머지 경력은 B2C SaaS·하드웨어 유통 영역입니다. 음향기기 하드웨어(리앤사) → 교육·문화·제조 대행(무버먼) → B2B 미술(마롱) → AI 오디오 B2C SaaS(사운드플랫폼) → 엔터프라이즈 AI B2B SaaS(올거나이즈). 매번 도메인이 바뀌었고, 매번 현장 사람들의 질문을 파악해 콘텐츠와 퍼널로 옮겼습니다. 리앤사에서는 하드웨어 브랜드 3종을 인지도 0에서 국내 런칭했고, 마롱에서는 경쟁사 3곳이 카피하는 상황에서 매출 140% 성장을 만들었고, 사운드플랫폼에서는 10개월 만에 80개국 5만 유저를 확보했습니다. 휴머노이드 로봇·VLS도 같은 방식을 출발점으로 삼되, 현장 제약이 더 큰 만큼 학습·검증 기간을 넓혀 진입할 예정입니다.'
      },
      {
        num: '03',
    ...
    jdRows: [
      ...
      { req: '엔지니어 대상 기술 글쓰기',                      project: '올거나이즈',                  result: 'PIP 필드리포트 4편(한·영) + 에이전틱 AI 가이드 10편, 상위 5개 기준 전환율 9.5~14.3%' },
      { req: '복잡한 기술 개념을 읽기 쉽게 전달',             project: '올거나이즈',                  result: 'LLM·RAG·MCP·온프레미스·GPU·보안 콘텐츠 제작 · 사범대 국어교육 전공' },
      { req: '한국어·영어 기술 문서 작성',                    project: '올거나이즈',                  result: '한글 12편+ · 영문 2편 제작 주도(AI 도구 보조 + 자체 교정) · 글로벌팀 주간 영문 보고. 실시간 영어 커뮤니케이션은 보완 영역' },
      { req: '기술 블로그·뉴스레터 직접 운영',                project: '올거나이즈',                  result: 'Webflow API 기반 블로그 기획~발행 자동화, MQL→SQL 너처링 설계' },
      { req: '컨퍼런스·전시 기획',                            project: '올거나이즈 · 사운드 · 리앤사', result: '2026 AI 엑스포(COEX) 기획·준비, 2024 월드IT쇼 부스, KOBA 음향기기 전시' },
      { req: 'CEO 미디어 인터뷰 준비 서포트',                 project: '올거나이즈',                  result: 'CEO·글로벌 리더십 주간 영문 커뮤니케이션 (근접 경험, 미디어 인터뷰 답변 초안 실무는 입사 후 보완)' },
